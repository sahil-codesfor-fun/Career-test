            ...
            <div className="w-full lg:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-12">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div className="flex flex-col items-start">
                  <h3 className="text-xl font-bold text-gray-800 mb-2">{tests[0]?.title || 'Engineering'}</h3>
                  <p className="text-gray-500 text-sm mb-4 min-h-[40px]">
                    {tests[0]?.description || "Civil, Computers, Mechanical or some other? Let's find out."}
                  </p>
                  <button 
                    onClick={() => handleStartTest(tests[0]?.id || 1)}
              ...
              <div className="flex gap-4 items-start">
                ...
                <div className="flex flex-col items-start">
                  <h3 className="text-xl font-bold text-gray-800 mb-2">{tests[1]?.title || 'Commerce'}</h3>
                  <p className="text-gray-500 text-sm mb-4 min-h-[40px]">
                    {tests[1]?.description || "Commerce and Business can be a confusing domain. Let's make sense of it all."}
                  </p>
                  <button 
                    onClick={() => handleStartTest(tests[1]?.id || 2)}
                    className="bg-brand-orange hover:bg-brand-orange/90 text-white border-none font-medium py-1.5 px-6 shadow-sm transition-colors rounded"
                  >
                    Start Test
                  </button>
              ...
              {/* Medical & Life Sciences (Index 2) */}
              <div className="flex gap-4 items-start">
                <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-red-100 text-red-600 shadow-sm flex-shrink-0">
                  <Activity className="w-6 h-6" />
                </div>
                <div className="flex flex-col items-start">
                  <h3 className="text-xl font-bold text-gray-800 mb-2">{tests[2]?.title || 'Medical & Life Sciences'}</h3>
                  <p className="text-gray-500 text-sm mb-4 min-h-[40px]">
                    {tests[2]?.description || "Physics, Chemistry or Pharmacy? Let's see where your interest lies."}
                  </p>
                  <button 
                    onClick={() => handleStartTest(tests[2]?.id || 3)}
                    className="bg-brand-orange hover:bg-brand-orange/90 text-white border-none font-medium py-1.5 px-6 shadow-sm transition-colors rounded"
                  >
                    Start Test
                  </button>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div className="flex flex-col items-start">
                  <h3 className="text-xl font-bold text-gray-800 mb-2">{tests[3]?.title || 'Humanities'}</h3>
                  <p className="text-gray-500 text-sm mb-4 min-h-[40px]">
                    {tests[3]?.description || "Know which humanities is right for you."}
                  </p>
                  <button 
                    onClick={() => handleStartTest(tests[3]?.id || 4)}
                    className="bg-brand-orange hover:bg-brand-orange/90 text-white border-none font-medium py-1.5 px-6 shadow-sm transition-colors rounded"
                  >
                    Start Test
                  </button>
          ...
          <div className="flex-1 md:border-r border-gray-300 md:pr-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div className="flex flex-col items-start">
                  <h3 className="text-lg font-bold text-gray-800 mb-2">{tests[4]?.title || '10+1 / 10+2'}</h3>
                  <p className="text-gray-500 text-sm mb-4 min-h-[40px]">
                    {tests[4]?.description || "See which stream you should select after 10th."}
                  </p>
                  <button 
                    onClick={() => handleStartTest(tests[4]?.id || 5)}
                    className="bg-brand-orange hover:bg-brand-orange/90 text-white border-none font-medium py-1.5 px-6 shadow-sm transition-colors rounded"
                  >
                    Start Test
                  </button>
              ...
              <div className="flex gap-4 items-start">
                ...
                <div className="flex flex-col items-start">
                  <h3 className="text-lg font-bold text-gray-800 mb-2">{tests[5]?.title || 'Diploma Courses'}</h3>
                  <p className="text-gray-500 text-sm mb-4 min-h-[40px]">
                    {tests[5]?.description || "You have tons of options to choose from."}
                  </p>
                  <button 
                    onClick={() => handleStartTest(tests[5]?.id || 6)}
                    className="bg-brand-orange hover:bg-brand-orange/90 text-white border-none font-medium py-1.5 px-6 shadow-sm transition-colors rounded"
                  >
                    Start Test
                  </button>
          ...
          <div className="flex-1 md:pl-4">
            ...
            <div className="grid grid-cols-1 gap-8">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div className="flex flex-col items-start">
                  <h3 className="text-lg font-bold text-gray-800 mb-2">{tests[6]?.title || 'Class 1st - 10th'}</h3>
                  <p className="text-gray-500 text-sm mb-4 min-h-[40px]">
                    {tests[6]?.description || "Find your passion!."}
                  </p>
                  <button 
                    onClick={() => handleStartTest(tests[6]?.id || 7)}
                    className="bg-brand-orange hover:bg-brand-orange/90 text-white border-none font-medium py-1.5 px-6 shadow-sm transition-colors rounded"
                  >
                    Start Test
                  </button>
